...
fetch(url)
  ...
  .then(function(data) {
    ...
    for (var x = 0; x <= 26; x++) {
      states.push(
        new State_Info(
          data.data.regional[x].loc,
          data.data.regional[x].confirmedCasesIndian,
          data.data.regional[x].discharged,
          data.data.regional[x].deaths
        )
      );
    }
    states.map((info, index) => {
      ...
      document.write(info.fcase());
      document.write(info.frecovered());
      document.write(info.fdead());
      document.write("<br />");
    });
  });
//     console.log(State)
...
// const url1 = "https://api.rootnet.in/covid19-in/stats/latest";
...
//   "pk.eyJ1IjoicmVkZmVkdGVkIiwiYSI6ImNrOGJ3d3k0bzBkZXczZG8xNWk3a3o4YXoifQ.WEVHaf3zd8D6r8p0K6Oxxg";
...
//       geometry: {
//         type: "Point",
//         coordinates: [78.317277, 10.71389]
//       },
//       properties: {
//         title: "Mapbox",
